...
function buyWeapon() {
    if(gold>=30){
        if(currentWeapon<weapons.length-1){
            ...
            goldText.innerText = gold;
            currentWeapon ++;
            text.innerText = "You know have a " + weapons[currentWeapon].name + ".";
            inventory.push(weapons[currentWeapon].name);
            text.innnerText = "In your inventory you have: " + inventory;
        }else{
            text.innerText = "You have reached the most powerful weapon.";
